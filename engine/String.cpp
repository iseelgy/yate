...
const ObjList& CapturedEvent::events()
{
	return s_cls_events;
}
 ...
 */
void CapturedEvent::append(int level, const char* text)
{
	if (text && *text) s_cls_events.append(new CapturedEvent(level, text));
}
...
{
	return s_cls_capturing;
}

void CapturedEvent::capturing(bool capture)
{
	s_cls_capturing = capture;
}
